...
/**
 * This class encapsulates the valid categories present in the input file.
 * Valid categories are PERSON, PLACE, ANIMAL, COMPUTER and OTHER. It also
 * contains an order in which the categories are to be displayed.
 *
 */
